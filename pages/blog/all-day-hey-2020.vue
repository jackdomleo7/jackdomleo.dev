<template lang="md">
  <blog-header :page-title="pageTitle" :date="new Date('2020-05-14')" :readMinutes="6" :hashtags="['AllDayHey', 'frontend', 'UI', 'UX', 'design']" :lead="pageDescription" />

  Today marks one week since the [All Day Hey](https://alldayhey.com?ref=jackdomleo.dev/blog/all-day-hey-2020) <time datetime="2020">2020</time> virtual conference. This year was my first time attending All Day Hey and my first virtual conference. Due to the global Coronavirus pandemic, All Day Hey was not able to be hosted in Leeds, UK, so [Josh Nesbitt](https://twitter.com/joshnesbitt), [Harry Roberts](https://twitter.com/csswizardry), [Phil Hawksworth](https://twitter.com/philhawksworth) and the rest of the All Day Hey team had to come up with a quick turn-around to make All Day Hey virtual... And they went above and beyond!
  ...
  **An affordable live-streamed, full-day conference for designers &amp; front-end developers.**
  ...
  The day began with Vitaly Friedman from [Smashing Magazine](https://www.smashingmagazine.com?ref=jackdomleo.dev/blog/all-day-hey-2020) discussing modern design patterns; the dos and don'ts of UI/UX and front-end in 2020. After reading the schedule for the day, this was the talk I was looking forward to the most, it seemed really up my street.
  ...
  [Charlotte Dann](https://charlottedann.com?ref=jackdomleo.dev/blog/all-day-hey-2020) blew the audience away with her CSS art! The founder of [Hexatope](https://hexatope.io?ref=jackdomleo.dev/blog/all-day-hey-2020) showed off stunning examples of her work and how a simple CSS algorithm can have unexpected, weird and wonderful outcomes. The power of `nth-child()` astounded us all. Definitely inspired me to look into doing some CSS art that's more interesting than my [pixel art R2-D2](https://codepen.io/JackDomleo/pen/ZEEqdxy).

  <p class="codepen" data-height="365" data-theme-id="default" data-default-tab="js,result" data-user="pouretrebelle" data-slug-hash="bPWvNp" data-preview="true" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="nth-child Art">
  ...
  <p class="codepen" data-height="365" data-theme-id="default" data-default-tab="result" data-user="kimblim" data-slug-hash="rNVgLor" data-preview="true" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="Accessible button 06">
  ...
  Asim references [The Climate Fix](https://theclimatefix.com?ref=jackdomleo.dev/blog/all-day-hey-2020) and the [Principles of Green Application Architecture Design](https://www.conserve-energy-future.com/materials-used-and-principles-green-architecture.php?ref=jackdomleo.dev/blog/all-day-hey-2020), which are two very useful references we **all** could use with taking note of. After all, we only have one planet (so far), so let's look after it. Asim also showed us a really good reference to an [interactive electricity world map](https://www.electricitymap.org/map?ref=jackdomleo.dev/blog/all-day-hey-2020) that outlines electricity consumption in different areas across the globe.
  ...
  You can still buy a pass for the day and watch the recorded talks through the [All Day Hey portal](https://alldayhey.com/live?ref=jackdomleo.dev/blog/all-day-hey-2020), where all the content will be available for up to 90 days after the event took place - All Day Hey 2020 took place on <time datetime="2020-05-07">7<sup>th</sup> May 2020</time>, so the content should be available until <time datetime="2020-08-05">5<sup>th</sup> August 2020</time>. I highly recommend this to anyone interested in front-end and design.
...
export default {
  ...
  data () {
    return {
      pageTitle: 'All Day Hey! 2020',
      pageDescription: 'All Day Hey 2020 was the first virtual conference I attended and I thought it was fantastic! Can\'t wait for 2021.'
    };
  },
  head () {
    return {
