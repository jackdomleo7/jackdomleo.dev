...
const { data } = await useAsyncData((ctx) => { return ctx!.$contentful.getEntries<ContentfulEntries.Product>({ content_type: 'product', limit: 1, 'fields.slug': $route.params.slug })})
