<template>
  <section id="top-projects">
    ...
    <div class="projects">
      <project-card header="Checka11y.css" description="A CSS stylesheet to quickly highlight a11y concerns." url="https://checka11y.jackdomleo.dev" image="/img/projects/checka11y.png" image-alt="Checka11y.css logo" />
